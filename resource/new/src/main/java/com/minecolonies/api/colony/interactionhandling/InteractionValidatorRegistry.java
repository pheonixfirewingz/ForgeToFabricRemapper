...
public final class InteractionValidatorRegistry
{
     ...
     */
    private static final Map<ITextComponent, Predicate<ICitizenData>> map = new HashMap<>();

    /**
     * Map of all pos based validator predicates.
     */
    private static final Map<ITextComponent, BiPredicate<ICitizenData, BlockPos>> posMap = new HashMap<>();

    /**
     * Map of all IToken based validator predicates.
     */
    private static final Map<ITextComponent, BiPredicate<ICitizenData, IToken<?>>> tokenMap = new HashMap<>();
