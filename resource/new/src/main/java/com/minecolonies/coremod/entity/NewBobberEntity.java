...
public class NewBobberEntity extends Entity implements IEntityAdditionalSpawnData
{
        ...
        else if (this.world.isRemote || !this.shouldStopFishing())
        {
            ...
            else
            {
                ...
                if (this.currentState == State.BOBBING)
                {
                    ...
                    this.setMotion(Vector3d.x * 0.9D, Vector3d.y - d0 * this.rand.nextFloat() * 0.2D, Vector3d.z * 0.9D);
    ...
    private void catchingFish(final BlockPos p_190621_1_)
    {
        ...
        if (this.ticksCatchable > 0)
        {
            ...
            {
                this.setMotion(this.getMotion().add(0.0D, -0.2D * this.rand.nextFloat() * (double) this.rand.nextFloat(), 0.0D));
            }
        }
        else if (this.ticksCatchableDelay > 0)
        {
            ...
            if (this.ticksCatchableDelay > 0)
            {
                ...
                final double d1 = (float) MathHelper.floor(this.getPosY()) + 1.0F;
        ...
        else if (this.ticksCaughtDelay > 0)
        {
            ...
            if (this.rand.nextFloat() < f5)
            {
                ...
                final double d5 = (float) MathHelper.floor(this.getPosY()) + 1.0F;
