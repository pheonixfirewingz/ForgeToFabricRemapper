package com.minecolonies.coremod.colony.colony.requestsystem.requests;
...
public final class StandardRequestFactories
{
    ...
    public static final class ItemStackRequestFactory implements IRequestFactory<Stack, ItemStackRequest>
    {
        /**
         ...
         */
        @Override
        public ItemStackRequest getNewInstance(
          @NotNull final Stack input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new ItemStackRequest(location, token, initialState, input);
        }

        @NotNull
        @Override
        @SuppressWarnings(Suppression.LEFT_CURLY_BRACE)
        public TypeToken<ItemStackRequest> getFactoryOutputType()
        {
            return TypeToken.of(ItemStackRequest.class);
        }
        ...
        public StandardRequests.ItemStackRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, Stack::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(ItemStackRequest.class),
                requested,
                token,
                requester,
                requestState));
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class ItemStackListRequestFactory implements IRequestFactory<StackList, ItemStackListRequest>
    {
        /**
         * Method to get a new instance of a request given the input and token.
         *
         ...
         */
        @Override
        public ItemStackListRequest getNewInstance(
          @NotNull final StackList input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new ItemStackListRequest(location, token, initialState, input);
        }

        @NotNull
        @Override
        @SuppressWarnings(Suppression.LEFT_CURLY_BRACE)
        public TypeToken<ItemStackListRequest> getFactoryOutputType()
        {
            return TypeToken.of(ItemStackListRequest.class);
        }
        ...
        public StandardRequests.ItemStackListRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, StackList::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(ItemStackListRequest.class),
                requested,
                token,
                requester,
                requestState));
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class ItemTagRequestFactory implements IRequestFactory<Tag, ItemTagRequest>
    {
        /**
         * Method to get a new instance of a request given the input and token.
         *
         ...
         */
        @Override
        public ItemTagRequest getNewInstance(
          @NotNull final Tag input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new ItemTagRequest(location, token, initialState, input);
        }

        @NotNull
        @Override
        @SuppressWarnings(Suppression.LEFT_CURLY_BRACE)
        public TypeToken<ItemTagRequest> getFactoryOutputType()
        {
            return TypeToken.of(ItemTagRequest.class);
        }
        ...
        public StandardRequests.ItemTagRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, Tag::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(ItemTagRequest.class),
                requested,
                token,
                requester,
                requestState));
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class DeliveryRequestFactory implements IRequestFactory<Delivery, DeliveryRequest>
    {

        @NotNull
        @Override
        @SuppressWarnings(Suppression.LEFT_CURLY_BRACE)
        public TypeToken<DeliveryRequest> getFactoryOutputType()
        {
            return TypeToken.of(DeliveryRequest.class);
        }
        ...
        public StandardRequests.DeliveryRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, Delivery::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(DeliveryRequest.class),
                requested,
                token,
                requester,
                requestState));
         ...
         */
        @Override
        public DeliveryRequest getNewInstance(
          @NotNull final Delivery input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new DeliveryRequest(location, token, initialState, input);
        }
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class PickupRequestFactory implements IRequestFactory<Pickup, PickupRequest>
    {

        @NotNull
        @Override
        @SuppressWarnings(Suppression.LEFT_CURLY_BRACE)
        public TypeToken<PickupRequest> getFactoryOutputType()
        {
            return TypeToken.of(PickupRequest.class);
        }
        ...
        public StandardRequests.PickupRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, Pickup::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(PickupRequest.class),
                requested,
                token,
                requester,
                requestState));
         ...
         */
        @Override
        public PickupRequest getNewInstance(
          @NotNull final Pickup input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new PickupRequest(location, token, initialState, input);
        }
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static abstract class AbstractCraftingRequestFactory<C extends AbstractCrafting, R extends AbstractCraftingRequest<C>>
    ...
    public static final class PrivateCraftingRequestFactory
      extends AbstractCraftingRequestFactory<PrivateCrafting, PrivateCraftingRequest>
    {

        public PrivateCraftingRequestFactory()
        {
            super((requested, token, requester, requestState) -> new PrivateCraftingRequest(requester, token, requestState, requested),
              PrivateCrafting.class,
              PrivateCraftingRequest.class,
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class PublicCraftingRequestFactory extends AbstractCraftingRequestFactory<PublicCrafting, PublicCraftingRequest>
    {

        public PublicCraftingRequestFactory()
        {
            super((requested, token, requester, requestState) -> new PublicCraftingRequest(requester, token, requestState, requested),
              PublicCrafting.class,
              PublicCraftingRequest.class,
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class ToolRequestFactory implements IRequestFactory<Tool, ToolRequest>
    {

        @Override
        public ToolRequest getNewInstance(
          @NotNull final Tool input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new ToolRequest(location, token, initialState, input);
        }

        @NotNull
        @Override
        public TypeToken<? extends ToolRequest> getFactoryOutputType()
        {
            return TypeToken.of(ToolRequest.class);
        }
        ...
        public StandardRequests.ToolRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, Tool::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(ToolRequest.class),
                requested,
                token,
                requester,
                requestState));
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class FoodRequestFactory implements IRequestFactory<Food, FoodRequest>
    {

        @Override
        public FoodRequest getNewInstance(
          @NotNull final Food input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new FoodRequest(location, token, initialState, input);
        }

        @NotNull
        @Override
        public TypeToken<? extends FoodRequest> getFactoryOutputType()
        {
            return TypeToken.of(FoodRequest.class);
        }
        ...
        public StandardRequests.FoodRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, Food::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(FoodRequest.class),
                requested,
                token,
                requester,
                requestState));
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class SmeltableOreRequestFactory implements IRequestFactory<SmeltableOre, SmeltAbleOreRequest>
    {

        @Override
        public SmeltAbleOreRequest getNewInstance(
          @NotNull final SmeltableOre input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new SmeltAbleOreRequest(location, token, initialState, input);
        }

        @NotNull
        @Override
        public TypeToken<? extends SmeltAbleOreRequest> getFactoryOutputType()
        {
            return TypeToken.of(SmeltAbleOreRequest.class);
        }
        ...
        public StandardRequests.SmeltAbleOreRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, SmeltableOre::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(SmeltAbleOreRequest.class),
                requested,
                token,
                requester,
                requestState));
    ...
    @SuppressWarnings(Suppression.BIG_CLASS)
    public static final class BurnableRequestFactory implements IRequestFactory<Burnable, BurnableRequest>
    {

        @Override
        public BurnableRequest getNewInstance(
          @NotNull final Burnable input,
          @NotNull final IRequester location,
          @NotNull final IToken<?> token,
          @NotNull final RequestState initialState)
        {
            return new BurnableRequest(location, token, initialState, input);
        }

        @NotNull
        @Override
        public TypeToken<? extends BurnableRequest> getFactoryOutputType()
        {
            return TypeToken.of(BurnableRequest.class);
        }
        ...
        public StandardRequests.BurnableRequest deserialize(@NotNull final IFactoryController controller, @NotNull final CompoundNBT nbt)
        {
            return deserializeFromNBT(controller, nbt, Burnable::deserialize,
              (requested, token, requester, requestState) -> controller.getNewInstance(TypeToken.of(BurnableRequest.class),
                requested,
                token,
                requester,
                requestState));
