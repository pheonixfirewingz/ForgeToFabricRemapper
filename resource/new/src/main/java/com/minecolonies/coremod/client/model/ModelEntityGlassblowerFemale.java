...
public class ModelEntityGlassblowerFemale extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public ModelEntityGlassblowerFemale()
    {
        ...
        gauntlet1.setRotationPoint(3.5F, 7F, -2.5F);
        gauntlet1.setTextureSize(128, 64);
        ...
        Hair1.setRotationPoint(-4F, -6F, -5F);
        ...
        Hair2.setRotationPoint(-4F, -9F, -5F);
        ...
        Hair4.setRotationPoint(-4F, -9F, 4F);
        ...
        Hair3.setRotationPoint(4F, -4F, 0F);
        ...
        Hair6.setRotationPoint(4F, -4F, -1F);
        ...
        bipedChest.setRotationPoint(0.5F, 0F, 0F);
        ...
        PonytailB.setRotationPoint(0F, 0F, 1F);
        ...
        PonytailT.setRotationPoint(0F, 1F, 1F);
        ...
        bipedHead.addChild(Hair192);
        bipedHead.addChild(Hair14);
        bipedHead.addChild(Hair20);
        bipedHead.addChild(Hair21);
        bipedHead.addChild(Hair16);
        bipedHead.addChild(Hair10);
        bipedHead.addChild(Hair9);
        bipedHead.addChild(Hair22);
        bipedHead.addChild(Hair23);
        bipedHead.addChild(Hair24);
        bipedHead.addChild(Hair25);
        bipedHead.addChild(Hair26);
        bipedHead.addChild(Hair28);
        bipedHead.addChild(Hair29);
        bipedHead.addChild(Hair30);
        bipedHead.addChild(Hair31);
        bipedHead.addChild(Hair32);
        bipedHead.addChild(Hair33);
        bipedHead.addChild(Hair35);
        bipedHead.addChild(Hair34);
        bipedHead.addChild(Hair37);
        bipedHead.addChild(Hair38);
        bipedHead.addChild(Hair39);
        bipedHead.addChild(Hair40);
        bipedHead.addChild(Hair42);
        bipedHead.addChild(Hair43);
        bipedHead.addChild(Hair41);
        bipedHead.addChild(Hair27);
        bipedHead.addChild(Hair44);
        bipedHead.addChild(Hair45);
        bipedHead.addChild(Hair46);
        bipedHead.addChild(Hair47);
        bipedHead.addChild(Hair48);
        bipedHead.addChild(Hair49);
        bipedHead.addChild(Hair51);
        bipedHead.addChild(Hair52);
        bipedHead.addChild(Hair55);
        bipedHead.addChild(Hair54);
        bipedHead.addChild(Hair53);
        bipedHead.addChild(Hair57);
        bipedHead.addChild(Hair58);
        bipedHead.addChild(Hair59);
        bipedHead.addChild(Hair60);
        bipedHead.addChild(Hair61);
        bipedHead.addChild(Hair62);
        bipedHead.addChild(Hair63);
        bipedHead.addChild(Hair56);
        bipedHead.addChild(Hair50);
