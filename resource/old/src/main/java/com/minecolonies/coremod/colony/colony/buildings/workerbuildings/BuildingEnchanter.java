...
import com.minecolonies.coremod.colony.colony.buildings.AbstractBuildingCrafter;
...
public class BuildingEnchanter extends AbstractBuildingCrafter
{
     ...
     */
    private final Map<BlockPos, Boolean> buildingToGatherFrom = new HashMap<>();
    ...
    public static class View extends AbstractBuildingWorker.View
    {
         ...
         * List of buildings the enchanter gathers experience from.
         */
        private final List<BlockPos> buildingToGatherFrom = new ArrayList<>();
