package com.minecolonies.coremod.colony.colony.colonyEvents.raidEvents;
...
public abstract class AbstractShipRaidEvent implements IColonyRaidEvent, IColonyStructureSpawnEvent
{
     ...
     */
    private final Map<Entity, UUID> raiders = new WeakHashMap<>();

    /**
     * Entities which are to be respawned in a loaded chunk.
     */
    private final List<Tuple<EntityType<?>, BlockPos>> respawns = new ArrayList<>();
