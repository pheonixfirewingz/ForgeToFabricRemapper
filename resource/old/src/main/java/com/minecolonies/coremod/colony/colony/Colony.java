...
import com.minecolonies.coremod.colony.colony.permissions.Permissions;
import com.minecolonies.coremod.colony.pvp.AttackingPlayer;
import com.minecolonies.coremod.colony.colony.requestsystem.management.manager.StandardRequestManager;
...
public class Colony
{
     ...
     * The request manager assigned to the colony.
     */
    private final IResearchManager researchManager = new ResearchManager();
