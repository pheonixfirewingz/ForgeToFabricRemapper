...
import com.minecolonies.api.client.render.modeltype.*;
...
public abstract class AbstractEntityCitizen extends AbstractCivilianEntity implements NamedScreenHandlerFactory
{
    /**
     ...
     */
    public AbstractEntityCitizen(final EntityType<? extends PassiveEntity> type, final World world)
    {
        super(type, world);
    }
    ...
    @NotNull
    @Override
    public ActionResult applyPlayerInteraction(final PlayerEntity player, final Vector3d vec, final Hand hand)
    {
     ...
     * @return the view.
     */
    public abstract CitizenDataView getCitizenDataView();
    ...
    @Nullable
    @Override
    public PassiveEntity func_241840_a(final ServerWorld world, final PassiveEntity parent)
    {
        return null;
    }
